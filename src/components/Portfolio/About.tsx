...
export const About = () => {
  ...
  return (
    <section id="about" className="py-16 px-4 sm:px-6 md:py-20 relative">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="section-title text-3xl sm:text-4xl md:text-5xl">About Me</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <motion.div
            ...
            className="card-glass relative group p-6 sm:p-8"
          >
            ...
            <div className="relative z-10">
              <div className="w-24 h-24 sm:w-32 sm:h-32 mx-auto mb-4 sm:mb-6 rounded-full bg-gradient-to-br from-primary to-secondary p-1">
                <div className="w-full h-full rounded-full bg-background flex items-center justify-center">
                  <span className="text-3xl sm:text-4xl font-bold gradient-text">PS</span>
                </div>
              </div>
              
              <h3 className="text-xl sm:text-2xl font-bold text-center mb-3 sm:mb-4 gradient-text">
                Piyush Saini
              </h3>
              
              <div className="space-y-2 sm:space-y-3 text-gray-300 text-sm sm:text-base">
                <div className="flex items-center justify-between">
                  <span className="text-xs sm:text-sm text-gray-400">University:</span>
                  <span>Lovely Professional University</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-xs sm:text-sm text-gray-400">Course:</span>
          ...
          >
            <div className="card-glass p-6 sm:p-8">
              ...
              <p className="text-base sm:text-lg leading-relaxed text-gray-300 mt-3 sm:mt-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="card-glass text-center p-5 sm:p-6">
                <div className="text-xl sm:text-2xl font-bold gradient-text">150+</div>
                <div className="text-xs sm:text-sm text-gray-400">DSA Problems Solved</div>
              </div>
              <div className="card-glass text-center p-5 sm:p-6">
                <div className="text-xl sm:text-2xl font-bold gradient-text">5+</div>
                <div className="text-xs sm:text-sm text-gray-400">AI/IoT Hackathons</div>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {hobbies.map((hobby, index) => (
              <motion.div
                ...
                className="card-glass text-center group cursor-pointer hover:bg-gradient-to-br hover:from-primary/20 hover:to-secondary/20 p-5 sm:p-6"
              >
                <hobby.icon className="w-7 h-7 sm:w-8 sm:h-8 mx-auto mb-2 sm:mb-3 text-primary group-hover:text-white transition-colors" />
                <h4 className="font-semibold mb-1 text-base sm:text-lg">{hobby.title}</h4>
